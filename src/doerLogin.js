...
<MuiThemeProvider muiTheme={getMuiTheme(lightBaseTheme)}>
        ...
        <div hidden={!this.state.userName}>
            ...
            <Tabs onSelect={this.handleSelect} selectedIndex={2}>
                ...
                <TabPanel>
                    <h2>Beneficiaries</h2>
                    <section className="info">
                        <FlatButton label="Add Beneficiaries" primary={true} onClick={this.openBen.bind(this)}/>
                    </section>
                    {this.state.beneficiaries.map (info => { return (
                    <p onDoubleClick={this.deleteBen.bind(this, info)}>
                ...
                <TabPanel>
                    ...
                    <FlatButton label="Define It" primary={true} onClick={this.openDef.bind(this)}/><br/>
                    ...
                    <FlatButton label="What to Expect" primary={true} onClick={this.openOut.bind(this)}/><br/>
                    ...
                    <table className="tg">
                        ...
                        <tr>
                            <td className="tg-6k2t">
                                {this.state.ninetydayGoals.map (cat => { return (
                                <tr onDoubleClick={this.delete90TableItem.bind(this, cat)}>{cat.category}
                                </tr>) })}
                            </td>
                            <td className="tg-6k2t">
                                {this.state.ninetydayGoals.map (owner => { return (
                                <tr>{owner.owner}</tr>) })}
                            </td>
                            <td className="tg-6k2t">
                                {this.state.ninetydayGoals.map (smartG => { return (
                                <tr>{smartG.smartGoals}</tr>) })}
                            </td>
                            <td className="tg-6k2t">
                                {this.state.ninetydayGoals.map (dateS => { return (
                                <tr>{dateS.dateSet}</tr>) })}
                            </td>
                            <td className="tg-6k2t">
                                {this.state.ninetydayGoals.map (endD => { return (
                                <tr>{endD.endDate}</tr>) })}
                            </td>
                            <td className="tg-6k2t">
                                {this.state.ninetydayGoals.map (goalM => { return (
                                <tr>{goalM.goalMet}</tr>) })}
                            </td>
                        </tr>
                    </table><br/>
                    ...
                    <section className="info">
                        ...
                        <FlatButton label="Add Score" primary={true} onClick={this.openScore.bind(this)}/>
                    </section>
                    <table className="tg">
                        <tr>
                            <th className="tg-yw4l">Category</th>
                        ...
                        <tr>
                            <td className="tg-6k2t">
                                {this.state.weeklyScore.map (cat => { return (
                                <tr onDoubleClick={this.deleteWeeklyTableItem.bind(this, cat)}>{cat.category}</tr>) })}
                            </td>
                            <td className="tg-6k2t">
                                {this.state.weeklyScore.map (owner => { return (
                                <tr>{owner.owner}</tr>) })}
                            </td>
                            <td className="tg-6k2t">
                                {this.state.weeklyScore.map (measurable => { return (
                                <tr>{measurable.measurable}</tr>) })}
                            </td>
                            <td className="tg-6k2t">
                                {this.state.weeklyScore.map (goal => { return (
                                <tr>{goal.goal}</tr>) })}
                            </td>
                            <td className="tg-6k2t">
                                {this.state.weeklyScore.map (weekB => { return (
                                <tr>{weekB.weekbegin}</tr>) })}
                            </td>
                            <td className="tg-6k2t">
                                {this.state.weeklyScore.map (weekE => { return (
                                <tr>{weekE.weekEnd}</tr>) })}
                            </td>
                        </tr>
                    </table><br/>
                    ...
                    <section className="info">
                        ...
                        <FlatButton label="Add Year Goals" primary={true} onClick={this.openYear.bind(this)}/>
                    </section>
                    <table className="tg">
                        <tr>
                            <th className="tg-yw4l">Category</th>
                        ...
                        <tr>
                            <td className="tg-6k2t">
                                {this.state.yearand3years.map (cat => { return (
                                <tr onDoubleClick={this.deleteYearlyTableItem.bind(this, cat)}>{cat.category}</tr>) })}
                            </td>
                            <td className="tg-6k2t">
                                {this.state.yearand3years.map (owner => { return (
                                <tr>{owner.owner}</tr>) })}
                            </td>
                            <td className="tg-6k2t">
                                {this.state.yearand3years.map (smartG => { return (
                                <tr>{smartG.smartGoals}</tr>) })}
                            </td>
                            <td className="tg-6k2t">
                                {this.state.yearand3years.map (dataS => { return (
                                <tr>{dataS.dateSet}</tr>) })}
                            </td>
                            <td className="tg-6k2t">
                                {this.state.yearand3years.map (endD => { return (
                                <tr>{endD.endDate}</tr>) })}
                            </td>
                            <td className="tg-6k2t">
                                {this.state.yearand3years.map (goalM => { return (
                                <tr>{goalM.goalMet}</tr>) })}
                            </td>
                        </tr>
                    </table>
        ...
        <Dialog title="Change Organization, First, & Last Name" actions={actions} open={this.state.open}>
            <input type="text" placeholder="organization name" ref={element=> this.newOrg = element} defaultValue={this.state.doer.general.organization} />
            <br/>
            <input type="text" placeholder="change first name" ref={element=> this.newName = element} defaultValue={this.state.doer.general.firstName} />
            <br/>
            <input type="text" placeholder="change last name" ref={element=> this.newLastName = element} defaultValue={this.state.doer.general.lastName} />
            <br/>
        ...
        <Dialog title="Change All Details" actions={actions2} open={this.state.open2}>
            <input type="text" placeholder="change Type of Entity" contentEditable={ true} ref={element=> this.newToE = element} defaultValue={this.state.doer.general.toE} />
            <br/>
            <input type="text" placeholder="Industry" ref={element=> this.newIndustry = element} defaultValue={this.state.doer.general.industry} />
            <br/>
            <input type="text" placeholder="Award" ref={element=> this.newAward = element} defaultValue={this.state.doer.general.award} />
            <br/>
        ...
        <Dialog title="Change All Purpose Sections" actions={actions3} open={this.state.open3}>
            <input type="text" placeholder="change Type of Story" ref={element=> this.newStory = element} defaultValue={this.state.doer.purpose.ourStory} />
            <br/>
            <input type="text" placeholder="Focus/Mission" ref={element=> this.newFocus = element} defaultValue={this.state.doer.purpose.focusMission} />
            <br/>
            <input type="text" placeholder="Niche" ref={element=> this.newNiche = element} defaultValue={this.state.doer.purpose.niche} />
            <br/>
        ...
        <Dialog title="Change All Contact Information" actions={actions4} open={this.state.open4}>
            <input type="text" placeholder="change phone" ref={element=> this.newPhone = element} defaultValue={this.state.doer.contact.phone} />
            <br/>
            <input type="text" placeholder="change website" ref={element=> this.newWebsite = element} defaultValue={this.state.doer.contact.website} />
            <br/>
            <RaisedButton label="Submit" primary={true} onClick={this.changeContact.bind(this)}/>
        </Dialog>

        <Dialog title="Add Goal" actions={actions5} open={this.state.open5}>
            Category:
            ...
            <input placeholder="S.M.A.R.T. Goals" ref={element=> this.smartGoals = element}/> Date Started: <input type="date" ref={element=> this.dateSet = element}/> Date End: <input type="date" ref={element=> this.datesend = element}/> Goal Met:
        ...
        <Dialog title="Add Score" actions={actions6} open={this.state.open6}>
            ...
            <input placeholder="Goal" ref={element=> this.weeklyGoal = element}/> Date Started: <input type="date" ref={element=> this.weeklyDatestart = element}/> Date End: <input type="date" ref={element=> this.weeklyDatesend = element}/>
            <RaisedButton label="+" primary={true} onClick={this.addScore.bind(this)}/>
        </Dialog>

        <Dialog title="Add Score" actions={actions7} open={this.state.open7}>
            ...
            <input placeholder="S.M.A.R.T. Goals" ref={element=> this.yearSmartGoals = element}/> Date Started: <input type="date" ref={element=> this.yearDatestart = element}/> Date End: <input type="date" ref={element=> this.yearDatesend = element}/> Goal Met:
        ...
        <Dialog title="Add Training Information" actions={actions8} open={this.state.open8}>
        ...
        <Dialog title="Add Beneficiary Name" actions={actions9} open={this.state.open9}>
        ...
        <Dialog title="Define Success" actions={actions10} open={this.state.open10}>
            <div>
                { this.overflowAlert() }
                <textarea className="form-control" onChange={this.handleChange.bind(this)} ref={element=> this.newSuc = element}></textarea>
                <span>{this.remainingCharacters()}</span>
            </div>
            <RaisedButton label="Add Success" primary={true} onClick={this.addSuc.bind(this)}/>
        </Dialog>

        <Dialog title="What Do We Expect" actions={actions11} open={this.state.open11}>
            <div>
                { this.overflowAlert() }
                <textarea className="form-control" onChange={this.handleChange.bind(this)} ref={element=> this.newOut = element}></textarea>
                <span>{this.remainingCharacters()}</span>
            </div>
