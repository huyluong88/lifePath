...
handleClose5 = () => this.setState({open5: !this.state.open5});
handleClose6 = () => this.setState({open6: !this.state.open6});
          ...
          <FlatButton label="Edit Name" primary={true}
            ...
            <FlatButton label="Edit Contact Info" primary={true}
              ...
              <FlatButton label="Add Employees" primary={true}
                onClick={this.openEmp.bind(this)}/>
              </section>
                {this.state.employees.map (info => {
                  return (<p onDoubleClick={this.deleteEmp.bind(this, info)}>
                            {info.employeeName}
                          </p>)
                })}<br/>
                </TabPanel>
            ...
            <Dialog
             ...
             <Dialog
                ...
                ref={element => this.newToE = element}
                defaultValue={this.state.donor.general.toE}/><br/>
                <input type="text" placeholder="Industry"
                ref={element => this.newIndustry = element}
                defaultValue={this.state.donor.general.industry}/><br/>
                <input type="text" placeholder="Interest"
                ref={element => this.newInterest = element}
                defaultValue={this.state.donor.general.interest}/><br/>
             ...
             <Dialog
                ...
                defaultValue={this.state.donor.purpose.ourStory}/><br/>
                <input type="text" placeholder="Focus/Mission"
                ref={element => this.newFocus = element}
                defaultValue={this.state.donor.purpose.focusMission}/><br/>
                <input type="text" placeholder="Niche"
                ref={element => this.newNiche = element}
                defaultValue={this.state.donor.purpose.niche}/><br/>
             ...
             <Dialog
                ...
                defaultValue={this.state.donor.contact.phone}/><br/>
                <input type="text" placeholder="change website"
                ref={element => this.newWebsite = element}
                defaultValue={this.state.donor.contact.website}/><br/>
